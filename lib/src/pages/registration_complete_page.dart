...
class _RegistrationCompletePageState extends State<RegistrationCompletePage> with TickerProviderStateMixin {
        ...
        child: SafeArea(
            child: Column(
              ...
              children: [
                ...
                (_animationComplete) ? Text("Registro completo", style: TextStyles().changeColor(TextStyles().primaryTextTheme.labelSmall, Colors.black38),): Container(height: 20,),
